...
global app
app = Flask(__name__)
CORS(app, supports_credentials=True,  resources={r"/*": {"origins": ["https://jam-web-ten.vercel.app", "https://zooming-exploration-production.up.railway.app" ], "allow_headers": ["Content-Type", "Authorization"]}})
